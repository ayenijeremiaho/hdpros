...
public class RoomController {
    ...
    @PostMapping("/{roomId}")
    public Response getSingleRoom (@ApiIgnore Principal principal, @PathVariable Long roomId) {
        RoomDTOResponse response = roomService.getSingleRoomForUser(principal.getName(), roomId);
